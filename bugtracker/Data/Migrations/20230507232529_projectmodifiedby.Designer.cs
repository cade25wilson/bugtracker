...
namespace bugtracker.Data.Migrations
{
    ...
    [Migration("20230507232529_projectmodifiedby")]
    partial class projectmodifiedby
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("bugtracker.Models.Issues", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("bugtracker.Models.Issues", b =>
                {
                    b.HasOne("Microsoft.AspNetCore.Identity.IdentityUser", "ClosedBy")
                        .WithMany()
                        .HasForeignKey("ClosedByFK");

                    b.HasOne("Microsoft.AspNetCore.Identity.IdentityUser", "Creator")
                        .WithMany()
                        .HasForeignKey("CreatorFK");

                    b.HasOne("bugtracker.Models.IssuePriority", "PriorityFK")
                        .WithMany()
                        .HasForeignKey("Priority")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("bugtracker.Models.IssueStatus", "StatusFK")
                        .WithMany()
